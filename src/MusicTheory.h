...
{
    constexpr int CHORD_NOTE_COUNT = 8; // How many notes can be selected within a chord
    constexpr int ROOT_MIN = 12;        // The minimal value for selecting the root note
    constexpr int ROOT_MAX = 107;       // The maximal value for selecting the root note
    constexpr int SCALE_COUNT = 10;     // Amount of scales
