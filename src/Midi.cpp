...
void playChannelNote(int channelNoteCounts[], int note, int velocity,
                     int midiChannel) {
  if (channelNoteCounts[note] > 0) {
...
void playNote(int pad, int j) {
  ...
  switch (pads[pad].chord.channel[j]) {
    case 0:
      ...
      break;
    case 1:
      playChannelNote(activeNotes.channelB, note, velocity,
                      settings.midiOutputBChannel);
      break;
    case 2:
      playChannelNote(activeNotes.channelC, note, velocity,
                      settings.midiOutputCChannel);
      break;
    case 3:
      playChannelNote(activeNotes.channelD, note, velocity,
