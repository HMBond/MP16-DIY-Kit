...
const char *midiNoteNames[128] = {
    ...
    "G#7",  "A7",   "A#7",  "B7",  // 96-107
    "C8",   "C#8",  "D8",   "D#8",  "E8",  "F8",  "F#8",  "G8",
    "G#8",  "A8",   "A#8",  "B8",                               // 108-119
    "C9",   "C#9",  "D9",   "D#9",  "E9",  "F9",  "F#9",  "G9"  // 120-127
};

int chordDegrees[7] = {0, 2,  4, 6,
                       8, 10, 12};  // Chord degrees for 1, 3, 5, 7, 9, 11, 13
